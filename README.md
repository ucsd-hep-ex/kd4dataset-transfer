...
│                         kd4dataset_transfer and configuration for tools like black
│
...
│
└── kd4dataset_transfer   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes kd4dataset_transfer a Python module
    │
